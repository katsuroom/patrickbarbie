...
const MapEditorToolbar = () => {
  ...
  const handleTextSizeClick = () => setTextSizePopupVisible(!isTextSizePopupVisible);
  const closeDropdown = () => {
  ...
  const FontDropdown = () => (
    <div style={dropdownStyle}>
      <div style={dropdownItemStyle} onClick={() => { console.log('Selected Font 1'); closeDropdown(); }}>Font Style 1</div>
      <div style={dropdownItemStyle} onClick={() => { console.log('Selected Font 2'); closeDropdown(); }}>Font Style 2</div>
      <div style={dropdownItemStyle} onClick={() => { console.log('Selected Font 3'); closeDropdown(); }}>Font Style 3</div>
    </div>
  );
  ...
  const handleShapeClick = () => setShapeDropdownVisible(!isShapeDropdownVisible);
  const closeShapeDropdown = () => setShapeDropdownVisible(false);

  const ShapeDropdown = () => (
    <div style={dropdownStyle}>
      <div style={{ display: 'flex' }}> {/* Row for shapes */}
        <div style={dropdownItemStyle} onClick={() => { alert('Triangle button clicked'); closeShapeDropdown(); }}><ChangeHistoryIcon /></div>
        <div style={dropdownItemStyle} onClick={() => { alert('Heart button clicked'); closeShapeDropdown(); }}><FavoriteBorderIcon /></div>
        <div style={dropdownItemStyle} onClick={() => { alert('Square button clicked'); closeShapeDropdown(); }}><CropSquareIcon /></div>
        <div style={dropdownItemStyle} onClick={() => { alert('Circle button clicked'); closeShapeDropdown(); }}><PanoramaFishEyeIcon /></div>
      </div>
      <div style={{ display: 'flex' }}> {/* Row for location and stars */}
        <div style={dropdownItemStyle} onClick={() => { alert('Add location button clicked'); closeShapeDropdown(); }}><LocationOnIcon /></div>
        <div style={dropdownItemStyle} onClick={() => { alert('Delete location button clicked'); closeShapeDropdown(); }}><LocationOffIcon /></div>
        <div style={dropdownItemStyle} onClick={() => { alert('Star button clicked'); closeShapeDropdown(); }}><StarBorderIcon /></div>
        <div style={dropdownItemStyle} onClick={() => { alert('Question mark button clicked'); closeShapeDropdown(); }}><HelpOutlineIcon /></div>
      </div>
    </div>
  );
